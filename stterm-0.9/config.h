...
static char *font = "AverageMono:style=Regular:pixelsize=19:antialias=true:autohint=true";
//static char *font = "Courier 10 Pitch:style=Regular:pixelsize=17:antialias=true:autohint=true";
