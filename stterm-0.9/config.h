...
//static char *font = "InconsolataGo Nerd Font Mono:style=Regular:pixelsize=17:antialias=true:autohint=true";
static char *font = "RobotoMono Nerd Font Mono:style=Regular:pixelsize=13:antialias=true:autohint=false";
